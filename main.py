...
if __name__ == '__main__':
    ...
    model = get_model(model=conf['model'],
                      ...
                      device=args.device)
    train_dataloader = Dataset(exp=args.exp, data=args.train, conf=conf['dataset'], device=args.device).get_dataloader()
    dev_dataloader = Dataset(exp=args.exp, data=args.dev, conf=conf['dataset'], device=args.device).get_dataloader()
